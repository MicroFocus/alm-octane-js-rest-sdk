...
class RequestHandler {
   ...
   */
  async get (url) {
    return this._requestor.get(url).catch(async err => {
   ...
   */
  async delete (url) {
    return this._requestor.delete(url).catch(async err => {
      await this._reauthenticate(err)
  ...
  async update (url, body) {
    return this._requestor.put(url, body).catch(async err => {
      await this._reauthenticate(err)
      return this._requestor.put(url, body)
    })
  }
  ...
  async create (url, body) {
    return this._requestor.post(url, body).catch(async err => {
      await this._reauthenticate(err)
  ...
  async getAttachmentContent (url) {
    return this._requestor.get(url, { headers: { accept: 'application/octet-stream' }, responseType: 'arraybuffer' }).catch(async err => {
      await this._reauthenticate(err)
      return this._requestor.get(url, { headers: { accept: 'application/octet-stream' }, responseType: 'arraybuffer' })
    })
  }
  ...
  async uploadAttachment (url, body) {
    return this._requestor.post(url, body, { headers: { 'content-type': 'application/octet-stream' } }).catch(async err => {
      await this._reauthenticate(err)
      return this._requestor.post(url, body, { headers: { 'content-type': 'application/octet-stream' } })
    })
  }
