...
class RequestHandler {
  ...
  /**
   * In case the previous request had a 401 sttus code, an authentication request must be fired.
   *
   * @param {Object} err - The error code of the previous error
   * @param {Object} requestOptions - The oprions for the new request
   * @param {String} method - A request method name (post/put/get/delete)
   * @returns - The error in case the authentication fails OR the response of the request if it was successfl
   */
