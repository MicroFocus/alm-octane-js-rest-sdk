...
class RequestHandler {
  ...
  async getAttachmentContent (url) {
    return this._requestor.get(url, { headers: { accept: 'application/octet-stream' } }).catch(async err => {
      await this._reauthenticate(err)
      return this._requestor.get(url, { headers: { accept: 'application/octet-stream' } })
    })
  }
