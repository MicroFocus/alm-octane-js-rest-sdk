...
describe('models/multi-reference', () => {
  ...
  it('should output the correct JSON string', () => {
    const expect = '{"total_count":2,"data":[{"id":"1043","type":"defect"},{"id":"1033","type":"defect"}]}'
  ...
  it('should add a new reference', () => {
    const expect = '{"total_count":3,"data":[{"id":"1043","type":"defect"},{"id":"1033","type":"defect"},{"id":"1","type":"defect"}]}'
    const refs = MultiReference.parse(defects)
